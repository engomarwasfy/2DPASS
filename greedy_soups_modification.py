...
if __name__ == '__main__':
        ...
        SOUPS_RESULTS_DIR = 'soups/greedy_soup_semanticKitti_modification'
        ...
        ingradientList = [0, 4, 0, 0, 8, 8, 4, 4, 8, 13, 13, 13, 8, 13, 0, 19, 8, 13, 19, 20, 0, 19, 2, 20, 0, 4]
        added_models_initial = 1

        for epoch in range(last_epoch, N+10000):
            print("epoch number ", epoch, " out of ", N+10000)
            if (epoch == last_epoch):
